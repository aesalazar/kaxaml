...
public class Reveal : Decorator
{
    ...
    public static readonly DependencyProperty IsExpandedProperty =
        DependencyProperty.Register(nameof(IsExpanded), typeof(bool), typeof(Reveal), new UIPropertyMetadata(false, OnIsExpandedChanged));
    ...
    public static readonly DependencyProperty DurationProperty =
        DependencyProperty.Register(nameof(Duration), typeof(double), typeof(Reveal), new UIPropertyMetadata(250.0));
    ...
    public static readonly DependencyProperty HorizontalRevealProperty =
        DependencyProperty.Register(nameof(HorizontalReveal), typeof(HorizontalRevealMode), typeof(Reveal), new UIPropertyMetadata(HorizontalRevealMode.None));
    ...
    public static readonly DependencyProperty VerticalRevealProperty =
        DependencyProperty.Register(nameof(VerticalReveal), typeof(VerticalRevealMode), typeof(Reveal), new UIPropertyMetadata(VerticalRevealMode.FromTopToBottom));
    ...
    public static readonly DependencyProperty AnimationProgressProperty =
        DependencyProperty.Register(nameof(AnimationProgress), typeof(double), typeof(Reveal), new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsMeasure, null, OnCoerceAnimationProgress));
    ...
    {
        if (reveal == HorizontalRevealMode.FromRightToLeft) return (percent - 1.0) * width;

        if (reveal == HorizontalRevealMode.FromCenterToEdge) return (percent - 1.0) * width * 0.5;
    ...
    {
        if (reveal == VerticalRevealMode.FromBottomToTop) return (percent - 1.0) * height;

        if (reveal == VerticalRevealMode.FromCenterToEdge) return (percent - 1.0) * height * 0.5;
    ...
    {
        if (reveal == HorizontalRevealMode.None) return originalWidth;
    ...
    {
        if (reveal == VerticalRevealMode.None) return originalHeight;
    ...
    private void SetupAnimation(bool isExpanded)
    {
        ...
        if (isExpanded) currentProgress = 1.0 - currentProgress;

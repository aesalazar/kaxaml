...
public class XmlFoldingBenchmarks
{
    ...
    public IList<XmlFoldData> CalculateXmlFolds_XmlTextReader()
    {
        ...
        using var reader = new XmlTextReader(new StringReader(SampleXml));
    ...
    public IList<XmlFoldData> CalculateXmlFolds_TurboXml()
    {
        ...
        var stack = new Stack<XmlFoldData>();
        var handler = new XmlFoldReadHandler(results, stack, IsShowingAttributesWhenFolded, SampleXml);
        XmlParser.Parse(SampleXml, ref handler);
...
";
    ...
    public IList<XmlFoldData> CalculateXmlFolds_RegExParsing()
    {
        ...
        var lineBreaks = PrecomputeLineBreaks(SampleXml);
        foreach (Match match in TagPattern.Matches(SampleXml))
        {
        ...
        foreach (Match match in CommentPattern.Matches(SampleXml))
        {
